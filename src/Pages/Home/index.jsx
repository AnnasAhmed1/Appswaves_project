    ...
    <main className="home-main-container ">
      <div className="container">
        ...
        <section className="crafting-section main-section">
          <div>
            <H2 text={"Crafting ROI-Centric Solutions Right!"} />
            <P1
              text={
        ...
        <div className="container">
          ...
          <section className="soundly-section">
            ...
            <div className="image-container">
              <img src={require("../../Assets/soundly_mobile.webp")} alt="" />
            </div>
          </section>
          <PersonalInfo
      ...
      <div className="container">
        <section className="main-section services-section">
          <H2 text={"Custom Software & Mobile App Development Company"} />
          <div>
            <P1
              text={
            ...
            <p className="helper-p1">
              Craft the ideal product by redirecting your strategy in the right
              direction. Start ahead with your
              <span> Android application development</span> journey. With your
              insights in mind, our collaborative sentiment will continue to
              grow – building robust and custom applications for you.
            </p>
            <H4 text={"Top-Rated iOS App Development Services"} />
            <p className="helper-p1">
              Hire iOS app developers from top-tier
              <span> iOS app development company</span> to kick-start your app
              entrepreneurial journey like never before!
            </p>
      ...
      >
        <div className="container">
          <H2 text={"Our Industry Expertise"} />
